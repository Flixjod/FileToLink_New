    ...
    async def load(cls, db):
        ...
        if not doc:
            ...
            doc = {
                ...
                # Per-user bandwidth (free users only)
                "user_bw_mode":           False,                # disabled by default
                "user_bw_limit":          int(os.environ.get("USER_BW_LIMIT", 10737418240)),  # 10 GB default
                # Global rolling reset tracking
                "global_bw_reset_date":   None,
            }
            ...
            defaults = {
                ...
                # New fields — migrate existing installs
                "user_bw_mode":         False,
                "user_bw_limit":        int(os.environ.get("USER_BW_LIMIT", 10737418240)),
                "global_bw_reset_date": None,
            }
